...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_NoteWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 36, 1)
    ...
    "NoteWidget\0updateNote\0\0titleChanged\0"
    "q\0"
};
...
const QMetaObject NoteWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NoteWidget.data,
      qt_meta_data_NoteWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NoteWidget.stringdata))
